...
# python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sql_compact.json  # DONE
# python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sparql_compact.json  # DONE
python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/cypher_compact.json
# python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sql_norange.json  # DONE
python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sparql_norange.json
python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/cypher_norange.json
python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sql_no-schema.json
python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sparql_no-schema.json
python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/cypher_no-schema.json